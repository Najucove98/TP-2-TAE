...
plot_ly(
  ...
  hoverinfo = "text",
  hovertext = paste0(
    "<b>Visitas total: </b>", datos_visita_unica$n_visitas_efectivas, "<br>",
    "<b>Tiempo total: </b>", datos_visita_unica$tiempo_promedio, "<br>",
    "<b>Gasto total: </b>", datos_visita_unica$gasto_promedio, "<br>",
    "<b>Paginas total: </b>", datos_visita_unica$paginas_promedio
  )
  ) %>% 
  layout(
    scene = list(
