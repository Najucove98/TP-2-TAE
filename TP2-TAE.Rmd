...
mapa_datos |> 
  ...
  addControl(
    html = tags$div(
      style = "font-size: 20px; font-weight: bold; background-color: white; padding: 6px; border-radius: 4px;",
      "Distribución Geográfica del Total de Visitas"), position = "topright")
